...
def scan():
    ...
    print(Fore.RESET + "\n")
    with open(f"./Program/scan_res/{filename}.hikariconsole", 'a') as f:
    ...
    try:
        ...
        for port in tqdm(range(1, int(max_ports)), desc=f"Scanning..", unit=" ports"):
            ...
            s.close()
        with open(f"./Program/scan_res/{filename}.hikariconsole", 'a') as f:
            f.write(f"*" * 52 + "\nReport generated by Hikari console.\n" + "*" * 52)
    ...
    print(Fore.GREEN + f"Saved the results to Program/scan_res/{filename}.hikariconsole")
    os.system('sleep 5')
    main.main()
